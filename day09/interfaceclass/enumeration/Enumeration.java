package com.classs.interfaceclass.enumeration;

/**
 * 열거형(Enumeration)
 * enum 키워드로 표현
 * 내부적으로 구현은 enum -> java.lang.Enum 클래스를 상속
...
enum Job { // 각 상수는 0 부터 숫자를 가지지만, 심볼로만 사용하고 숫자는 사용하지 않음
    STUDENT, MARKETING, DEVELOPER, CHIEF_EXCUTIONAL_OFFICER; //열거형 상수
}
...
public class  Enumeration{
    public static void main(String[] args) {
        ...
        if( job == Job.CHIEF_EXCUTIONAL_OFFICER){
