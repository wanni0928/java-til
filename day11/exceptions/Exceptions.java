 ...
 *
 * 예외 (Exception)
 *  - 오류에 비해서 심각도 낮고, 프로그램의 정상적인 흐름만 방해
...
public class Exceptions {
    public static void main(String[] args) {
        ...
        } catch (Exception e){ // 던져서 예외를 받음 (catch)
...
//        } catch (ArithmeticException e){ // 첫번째 캐치 후에 두번째 캐치
//
...
class CheckedExceptionhrow {
    ...
    void methodB() {
        try{
            ...
            System.out.println("methodA failed!!!");
        }
    }
}
