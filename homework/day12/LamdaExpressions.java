...
//        System.out.println(algorithm.test(board, moves, answer, (x, y) -> new Crane().solution(x, y)));
//    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(algorithm.test(genres, plays, answer, (x, y) -> new BestAlbum().solution(x, y)));
    }
